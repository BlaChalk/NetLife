...
<body>
    ...
    <div id="section9" class="Container">
        <div class="row h-100">
            <div class="col-sm-8 col-12">
                ...
                <h4 class="text text-9">我們就如同一艘小船行經在名為數位科技的水域上，水帶給我們方便，也能將我們覆滅。我們想利用網站有系統地呈現一套針對『數位成癮』的學習資源，以提升家長與孩子對數位成癮的認知，一起學習健康的使用習慣。讓家長放心孩子們使用數位科技，孩子擁有更豐富的學習資源。</h4>
            </div>
            <div class="col-sm-8 col-12 ml-sm-5">
                <div id="title-7-2" class="title-bg h-2">
                    <h2 class="title">理念誕生</h2>
                </div>
                <h4 class="text text-9">在數位時代成長的我們，比父母輩擁有更多的資源可以自由學習，但數位的世界充滿豐富刺激的體驗，孩子們容易受此吸引，甚至養成不當的使用習慣。父母們常選擇極端的方式禁止孩子使用，經常導致嚴重的家庭問題，甚至讓孩子們失去一個學習的管道。我們希望透過資源整合的方式，提升家長與孩子對於數位成癮的認知，共同學習數位健康的的重要。</h4>
            </div>
    ...
    <div id="section10" class="Container">
        <div class="row h-100 align-items-center justify-content-center">
            <img id="line-vertical" src="/img/line-vertical.svg" alt="">
